          ...
          {currentStep === 4 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold mb-2">All set! 🎉</h2>
                <p className="text-muted-foreground">You're ready to create amazing content – finish setup in dashboard</p>
              </div>
              ...
              <Card className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 border-2 border-primary/20">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <Target className="h-4 w-4 text-muted-foreground" />
                    <span>Goal: {GOALS.find(g => g.id === formData.goal)?.label}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-muted-foreground" />
                    <span>AI Persona: {formData.personaName} ({formData.writingStyle}, {formData.tone})</span>
                  </div>
                </div>
              </Card>
              ...
              <div className="flex items-start gap-3 p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                    You'll be redirected to your dashboard. A quick popup will guide you through the remaining setup before using tools.
                  </p>
                </div>
              </div>
            </div>
