    ...
    <section className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-5 sm:space-y-6 lg:space-y-8 animate-fade-in-up">
          ...
          {/* Feature cards - Compact UI - Right after benefits */}
          <div className="grid grid-cols-1 gap-3 max-w-2xl mx-auto pt-3 sm:pt-4">
              {/* AI Persona - Compact */}
              <div className="rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-gradient-to-br from-white/90 via-blue-50/30 to-indigo-50/20 dark:from-slate-900/90 dark:via-blue-950/30 dark:to-indigo-950/20 backdrop-blur-sm shadow-md hover:shadow-lg p-4 hover-lift text-left transition-all">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 via-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-md flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-[10px] font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wide">Persona</span>
                    </div>
                    <h4 className="text-sm font-semibold mb-1">Your authentic voice</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">AI learns your unique style and creates content that sounds like YOU, not a robot.</p>
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Authentic</span>
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Voice AI</span>
                    </div>
                  </div>
                </div>
              </div>

              {/* Profile Analyzer - Compact */}
              <div className="rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-gradient-to-br from-white/90 via-purple-50/30 to-pink-50/20 dark:from-slate-900/90 dark:via-purple-950/30 dark:to-pink-950/20 backdrop-blur-sm shadow-md hover:shadow-lg p-4 hover-lift text-left transition-all">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 via-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-md flex-shrink-0">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-[10px] font-semibold text-purple-600 dark:text-purple-400 uppercase tracking-wide">Analyzer</span>
                    </div>
                    <h4 className="text-sm font-semibold mb-1">Profile optimization</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">Get AI-powered score & actionable tips to boost your LinkedIn visibility.</p>
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Score</span>
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Tips</span>
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Insights</span>
                    </div>
                  </div>
                </div>
              </div>

              {/* Smart Comments - Compact */}
              <div className="rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-gradient-to-br from-white/90 via-indigo-50/30 to-purple-50/20 dark:from-slate-900/90 dark:via-indigo-950/30 dark:to-purple-950/20 backdrop-blur-sm shadow-md hover:shadow-lg p-4 hover-lift text-left transition-all">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 via-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-md flex-shrink-0">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-[10px] font-semibold text-indigo-600 dark:text-indigo-400 uppercase tracking-wide">Engagement</span>
                    </div>
                    <h4 className="text-sm font-semibold mb-1">Smart comments</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">Generate genuine comments that build real relationships and conversations.</p>
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Genuine</span>
                      <span className="px-1.5 py-0.5 text-[10px] rounded-full border bg-muted">Engage</span>
                    </div>
                  </div>
                </div>
              </div>
