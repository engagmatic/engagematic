...
class ApiClient {
  ...
  async getContentHistory(params = {}) {
    ...
    return this.request(`/content/history${queryString ? `?${queryString}` : ''}`);
  }
  ...
  async getSavedContent(params = {}) {
    const queryString = new URLSearchParams(params).toString();
    return this.request(`/content/saved${queryString ? `?${queryString}` : ''}`);
  }
  ...
  async getUsageHistory(params = {}) {
    const queryString = new URLSearchParams(params).toString();
    return this.request(`/analytics/usage/history${queryString ? `?${queryString}` : ''}`);
  }

  async getEngagementAnalytics(params = {}) {
    const queryString = new URLSearchParams(params).toString();
    return this.request(`/analytics/engagement${queryString ? `?${queryString}` : ''}`);
  }
