...
export const config = {
  ...
  // Database
  MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://markitzenagency_db_user:Slb9AZ9M4CvW4xlB@cluster0.wabbygn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
  ...
  // Google AI
  GOOGLE_AI_API_KEY: process.env.GOOGLE_AI_API_KEY || 'AIzaSyDM8pZABzzL3hMvSmtxQxMAE-WNEScFBFY',
